  ...
  useEffect(() => {
    if (isUserLoggedIn) {
      async function getWatchHistory() {
        try {
          const response = await watchHistoryService.getWatchHistory(false);
          console.log("response of watchhistory is", response);
        ...
        <div className="flex justify-center items-center h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-gray-500 mt-2">
              You have not watched any videos. Go & Enjoy!
            </p>
          </div>
        </div>
      ) : (

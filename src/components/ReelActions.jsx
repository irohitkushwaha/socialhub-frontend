      ...
      <div className="flex flex-col items-center gap-[4px] w-[36PX] justify-center">
        ...
        >
          {!isAutoScrollEnabled ? (
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill={iconColor}><path d="M480-80 200-360l56-57 184 184v-287h80v287l184-183 56 56L480-80Zm-40-520v-120h80v120h-80Zm0-200v-80h80v80h-80Z"/></svg>
            // <span

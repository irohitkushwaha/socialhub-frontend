...
//     link: "/",
//     subItems: [
//       { id: "history", icon: faHistory, text: "Watch History", link: "/youtube/watch-history" },
...
const MainNavItem = ({ icon, text, isSelected, onClick, to }) => (
  <Link
    to={to || "#"}
    onClick={(e) => {
      // Prevent default navigation for items with subnav that need to toggle
...
const SideNav = () => {
  ...
  // // Determine which nav is active based on current route
  // useEffect(() => {
  ...
  return (
    <div className="lg:border-r-2 lg:border-[#D5D7DA] lg:h-screen">
